...
function test() {
    return __awaiter(this, void 0, void 0, function () {
        var noticesSnapshot, eventsSnapshot, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    console.log('Fetching notices...');
                    return [4 /*yield*/, (0, firestore_1.getDocs)((0, firestore_1.collection)(db, 'notices'))];
                case 1:
                    noticesSnapshot = _a.sent();
                    console.log("Found ".concat(noticesSnapshot.size, " notices."));
                    noticesSnapshot.forEach(function (doc) {
                        console.log(doc.id, '=>', doc.data());
                    });
                    console.log('Fetching events...');
                    return [4 /*yield*/, (0, firestore_1.getDocs)((0, firestore_1.collection)(db, 'events'))];
                case 2:
                    eventsSnapshot = _a.sent();
                    console.log("Found ".concat(eventsSnapshot.size, " events."));
